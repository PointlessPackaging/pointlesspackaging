...
class PredictedImagePostAdmin(admin.ModelAdmin):
    ...
    list_display = (
    'img_post', 'get_username', 'get_name', 'materials', 'score', 'outer_size', 'inner_size', 'item_size')
    search_fields = (
    'img_post__user_id__email', 'packager__brand_name', 'materials', 'score', 'outer_size', 'inner_size', 'item_size')
    readonly_fields = ()
